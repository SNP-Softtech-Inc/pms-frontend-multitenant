...
const PaymentStep = ({ 
  ...
  const selectedMethod = paymentMethods.find(m => m.value === formData.payments.method);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Show validation errors */}
      {(stepErrors.method || stepErrors.amount) && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger 
                    id="payment-method"
                    className={stepErrors.method ? 'border-red-500' : ''}
                  >
                ...
                {stepErrors.method && (
                  <p className="text-sm text-red-500">{stepErrors.method}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    value={formData.payments.amount || 0}
                    onChange={(e) => handleFieldChange('amount', parseFloat(e.target.value) || 0)}
                    className={`pl-7 ${stepErrors.amount ? 'border-red-500' : ''}`}
                    onBlur={() => handleBlur('amount')}
                    readOnly
                  />
                </div>
                <p className="text-sm text-gray-500">
                  {stepErrors.amount || getAmountSource()}
                </p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium text-gray-900">
                  {selectedMethod?.label || 'Not specified'}
                </span>
              </div>
        ...
        <div className="lg:col-span-1">
          <Card className="bg-blue-50 border-blue-200">
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="font-semibold text-blue-900 mb-1">Credit Card:</p>
                <p className="text-sm text-blue-800">Best for online payments and faster processing.</p>
              </div>
              <div>
                <p className="font-semibold text-blue-900 mb-1">Bank Transfer:</p>
                <p className="text-sm text-blue-800">Lower fees, good for large amounts.</p>
              </div>
              <div>
                <p className="font-semibold text-blue-900 mb-1">PayPal:</p>
                <p className="text-sm text-blue-800">Familiar to most clients, secure.</p>
              </div>
              <div>
                <p className="font-semibold text-blue-900 mb-1">Cash/Check:</p>
                <p className="text-sm text-blue-800">Traditional methods, may require more follow-up.</p>
              </div>
            </CardContent>
          </Card>
        </div>
