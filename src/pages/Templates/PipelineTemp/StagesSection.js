                  ...
                  <Box sx={{ mt: 2 }}>
                      ...
                      {stage.automations && stage.automations.length > 0 ? (
                        ...
                        >
                          {stage.automations.map((automation, autoIndex) => {
                              ...
                              switch (automation.type) {
                                case "Create Task":
                                  return taskTemplateOptions.find(
                                    (opt) =>
                                      opt.value === automation.selectedtemp,
                                  )?.label;
                                case "Send Email":
                            ...
                            const tagDetails = automation.selectedTags
                            ...
                            return (
                              ...
                              >
                                ...
                                {automation.type === "Update job assignees" &&
                                  automation.selectedAssignees &&
                                  automation.selectedAssignees.length > 0 && (
                                    <Box sx={{ mb: 1 }}>
                                      <Typography
                                        variant="caption"
                                        color="text.secondary"
                                      ...
                                      >
                                        {automation.selectedAssignees.map(
                                          (userId, userIndex) => {
                                ...
                                {automation.type === "Update job assignees" &&
                                  automation.assigneesToRemove &&
                                  automation.assigneesToRemove.length > 0 && (
                                    <Box sx={{ mb: 1 }}>
                                      <Typography
                                        variant="caption"
                                        color="text.secondary"
                                      ...
                                      >
                                        {automation.assigneesToRemove.map(
                                          (userId, userIndex) => {
                                            const user = users.find(
                                              (u) => u.value === userId,
                                            );
                    ...
                    {stage.automations && stage.automations.length > 0 ? (
                      ...
                      <Button
                        ...
                        onClick={(event) =>
                          handleAutomationMenuOpen(event, index)
                        }
                      >
                        Add Automation
                      </Button>
