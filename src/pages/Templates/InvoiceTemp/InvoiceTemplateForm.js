        ...
        <Box>
          ...
          >
            ...
            <Button
              ...
              sx={{
                color: "#1168bf",
                textTransform: "none", // keeps "Preview" normal (not uppercase)
                padding: 0, // optional: removes extra padding
                minWidth: "auto", // optional: makes it compact
              }}
            >
              Preview
            </Button>
                ...
                <Box m={2}>
                  ...
                  <Box sx={{ mt: 2 }}>
                    <Button
                      variant="contained"
                      color="primary"
                      onClick={onToggleShortcutDropdown}
                    >
                      Add Shortcode
                    </Button>
                    ...
                    <ShortcodePopover
                      ...
                      onClose={onCloseShortcutDropdown}
                      shortcuts={filteredShortcuts}
                      onSelectShortcut={onAddShortcut}
                    />
                  </Box>
                      ...
                      <>
                        ...
                        <Box sx={{ mt: 1 }}>
                          ...
                          <ShortcodePopover
                            ...
                            onSelectShortcut={onSwitchAddShortcut}
                          />
                        </Box>
                      </>
                    )}
