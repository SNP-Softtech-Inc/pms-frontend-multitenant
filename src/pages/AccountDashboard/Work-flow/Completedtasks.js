...
//     try {
//       const res =
//         await accountTasksAPI.getCompletedTasksByAccount(accountId);
...
//         Completed Tasks (Account) ({tasks.length})
//       </Typography>
...
const Completedtasks = () => {
  ...
  const fetchTasks = async () => {
    try {
      const res =
        await accountTasksAPI.getCompletedTasksByAccount(
          accountId
        );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Successfully completed account tasks
          </p>
        </div>
