...
return (
  <div className="fixed inset-0 z-50 overflow-hidden">
    ...
    >
        ...
        >
          ...
          <div className="bg-primary px-8 py-8 text-primary-foreground">
            <div className="flex flex-col md:flex-row md:justify-between gap-6">
              ...
              <div className="rounded-2xl bg-white/10 border border-white/10 px-5 py-3 text-right backdrop-blur-sm">
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <p className="pt-2">{companyInfo.email}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <p>{clientInfo.city}</p>
                  <p className="pt-2">{clientInfo.email}</p>
          ...
          {/* Details */}
          <div className="grid md:grid-cols-4 gap-6 px-8 py-6 bg-muted/40 border-b border-border text-sm">
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{currency} USD</p>
            </div>
          </div>

          {/* Description */}
          {description && (
            <div className="px-8 py-5 border-b border-border text-sm text-muted-foreground">
          ...
          {/* Totals */}
          {rows.length > 0 && (
            <div className="px-8 py-8 bg-muted/30 border-t border-border flex justify-end">
              <div className="w-full max-w-sm border border-border bg-background rounded-2xl p-6 space-y-4">
          ...
          {/* Footer */}
          <div className="px-8 py-6 border-t border-border text-center text-sm text-muted-foreground bg-muted/20">
      ...
      {/* Actions */}
      <div className="flex justify-end gap-3 px-6 py-4 border-t border-border bg-background shrink-0">
